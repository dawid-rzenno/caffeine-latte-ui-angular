...
export class StatusService {
  private readonly statusesMaxCount: number = 10;
  private readonly statusTimeoutInMs: number = 5 * 1000;
  private readonly availableStatusIds: number[] = this.generateAvailableStatusIds();
  private readonly _statuses$: BehaviorSubject<InstantiatedStatus[]> = new BehaviorSubject<InstantiatedStatus[]>([]);
